...
def upload_file():
    ...
    # Local file path
    local_file_path = "biteboxx-backend/admin/app/Http/Controllers/Api/V1/Auth/CustomerAuthController.php"
    
    # Remote file path (relative to FTP root)
    remote_file_path = "admin/app/Http/Controllers/Api/V1/Auth/CustomerAuthController.php"
