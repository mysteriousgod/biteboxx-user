...
def download_and_check():
    ...
    try:
        ...
        # Download CustomerAuthController.php
        remote_path = "admin/app/Http/Controllers/Api/V1/Auth/CustomerAuthController.php"
        local_path = "downloaded_CustomerAuthController.php"
        ...
        if start != -1:
            # Show first 1500 chars of the method
            end = start + 1500
            print("\n=== firebase_auth_verify method on server ===")
